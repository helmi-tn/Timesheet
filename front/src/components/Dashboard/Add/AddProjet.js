...
function AddProjet() {
  ...
  const [postDataProjet,setPostDataProjet] = useState({
    nom:"",description:"",datededbut:"",datedefin:"",total:0,chef:"",/*taches:null*/
})
  const [postDataTache,setPostDataTache] = useState({
    nom:"",description:"",total:0,projet:null
})
...
const handleChangeSelectTaches = ((e) => {
  ...
  return (
    ...
    <Modal centered show={showTache} onHide={handleCloseTache}>
        ...
        <Modal.Footer>
          <Button variant="dark" onClick={handleCloseTache}>
            Retourner
          </Button>
          <Button  type="submit">
            Confirmer
