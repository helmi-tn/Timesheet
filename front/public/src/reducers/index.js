...
import tachestotal from './collab/tachestotal';
import collabsEtTaches from './admin/collabsEtTaches';

export default combineReducers({
    monthsheet,daysheets,comptes,projets,equipes,taches,totalsProjets,tachesOfProjet,projet,colabsByEquipe,equipe,compte,tachesByCollab,auth,user,tachestotal,collabsEtTaches
})