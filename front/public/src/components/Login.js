...
const Login = () =>  {
  ...
  return (
    ...
    <p style={{fontSize:30}}><b>Connexion</b></p>
        ...
        <Button variant="contained" style={{ background : 'black' ,'&:hover':{background: "linear-gradient(to right, black,#dedede)",color:'white'}  }} type='submit'>Se connecter</Button>
        {
          confirmer &&
          <center>
                <Alert style={{width:'330px',left:'22%',top:'62%',position:'absolute'}} severity="error">
                <b>Email ou mot de passe incorrecte</b>
                </Alert>
                </center>
        }
        ...
        alt="UIB Logo"
        src="https://i.imgur.com/rE74Jsm.png"                         
      />
      </Box>
        </Container>
      </Container>
